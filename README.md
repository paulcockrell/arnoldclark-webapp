...
2. Install webapp and run
  1. git clone https://github.com/paulcockrell/arnoldclark-webapp.git
  2. bundle
  3. bundle exec rails s -p 3000 # this port number is vital
3. Install api app and run
  1. git clone https://github.com/paulcockrell/arnoldclark-api.git
  2. bundle
  3. bundle exec rails-api s -p 3001 # this port number is vital
...
1. bundle exec rspec -f documentation
